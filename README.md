...
## Dataset.tar.xz
This folder contains all the 3DSM-cyc instances that were used during experiments, as well as the source code for the generator.
The instances contain N agents from each set, where N = {4, 5, 6, 7, 8, 9, 10, 11, 12, 14, 16, 18, 20, 23, 26, 29, 32, 35, 40, 45, 50, 60, 70, 80, 90, 100, 110, 120, 130}.
